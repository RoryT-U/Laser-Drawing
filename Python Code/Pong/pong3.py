...
def start_pong_game():
    ...
    while running:
        ...
        to_send = []
        add_paddle_coords(to_send, player_one_x, player_one_y, 255, False)
        to_send[-1] = 0
...
def add_paddle_coords(coords:list, paddle_x, paddle_y, colour, is_paddle_two):

    for offset in paddle_1_coords if is_paddle_two else paddle_2_coords:
      y = paddle_y+offset[1]
