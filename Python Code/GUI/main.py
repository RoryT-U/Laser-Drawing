...
on_off_button = tk.Button(top_frame, text="Off", command=switch_on_off, width=20, height=2, bg="red", relief=tk.RAISED)
on_off_button.pack(side="left", padx=10, pady=10)

# SETTINGS button
settings_button = tk.Button(top_frame, text="Settings", command=settings_action, width=20, height=2)
...
# Buttons for modes
draw_button = tk.Button(mode_frame, text="Draw", command=draw_mode_action, width=15, height=4)
draw_button.grid(row=0, column=0, padx=5, pady=5)

image_button = tk.Button(mode_frame, text="Image", command=image_mode_action, width=15, height=4)
image_button.grid(row=0, column=1, padx=5, pady=5)

camera_button = tk.Button(mode_frame, text="Camera", command=camera_mode_action, width=15, height=4)
camera_button.grid(row=1, column=0, padx=5, pady=5)

presets_button = tk.Button(mode_frame, text="Presets", command=presets_mode_action, width=15, height=4)
...
mode_settings_label = tk.Label(mode_settings_frame, text="MODE SETTINGS", font=("Arial", 18))
mode_settings_label.pack(expand=True)

# General settings frame
general_settings_frame = tk.Frame(left_frame, width=340, height=120, relief="solid", bd=1)
general_settings_frame.pack(pady=10)

general_settings_label = tk.Label(general_settings_frame, text="GENERAL SETTINGS", font=("Arial", 14))
...
laser_preview_label = tk.Label(right_frame, text="LASER PREVIEW PANEL", font=("Arial", 24))
