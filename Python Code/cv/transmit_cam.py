...
cv2.createTrackbar('Lower', 'canny',255,255,nothing)
cv2.createTrackbar('Upper', 'canny',255,255,nothing)
...
while True:
    ...
    frame = segmentor.removeBG(frame, (0,255,0) ,cutThreshold=800/1000)
    ...
    if True: # press esc to stop
        ...
        path.append((selected_points[current_index][0], selected_points[current_index][1],0))
